...
public interface ThemeDAOQuery {
    ...
    public final static String GET_THEMES_BY_GROUP_ID = "select hex(id) as id, hex(userid) as userid, hex(groupid) as groupid, title, content, last_modified, creation_timestamp from themes where groupid = unhex(?)";
